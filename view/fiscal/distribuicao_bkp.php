                                ...
                                <table id="tabela_2" class="table table-sm table-nowrap table-striped table-bordered display">
                                    ...
                                    <tbody>
                                        ...
                                        while ($secao = $result88->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $result888 = $db->prepare("SELECT v.id, v.nome, v.celular, lv.NM_LOCAL_VOTACAO,  lv.NM_BAIRRO, r.nome AS regional         
                                                                       FROM 2024_voluntarios AS v  
                                                                       INNER JOIN 2024_secoes AS s ON s.NR_ZONA = v.zona AND s.NR_SECAO = v.secao_numero 
                                                                       INNER JOIN 2024_locais_votacao AS lv ON lv.ID = s.LOCAL_VOTACAO_ID 
                                                                       INNER JOIN sys_regionais AS r ON r.id = lv.REGIONAL_ID 
                                                ...
                                                <td class=" text-center">
                                                    ...
                                                    while ($fiscais = $result888->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        <span>
                                                            ...
                                                            <p class="pading-distribuicao">
                                                                <b>Local: </b> <?= $fiscais['NM_LOCAL_VOTACAO']; ?>
                                                            </p>
                                                            
                                                            <p class="pading-distribuicao">
                                                                <b>Bairro: </b> <?= $fiscais['NM_BAIRRO']; ?>
                                                            </p>
                                                            
                                                            <p class="pading-distribuicao">
                                                                <b>Regional: </b> <?= $fiscais['REGIONAL']; ?>
                                                            </p>
                                                        </span>
                                                        <?php
                                                    }
                                ...
                                <select id="pessoas_supervisor" name="pessoas_supervisor" class="form-control select2" style="width: 100%;">
                                    ...
                                    if (
                                        ...
                                        $result8 = $db->prepare("SELECT b.REGIONAL_NOME, e2j.NM_LOCAL_VOTACAO, p.secao_numero, p.bsc_bairros_id, b.NM_BAIRRO AS bairro, p.zona, p.local_votacao, p.id, p.nome    
                                                                 ...
                                                                 INNER JOIN 2024_locais_votacao AS e2j ON e2j.ID = s.LOCAL_VOTACAO_ID 
                                                                 INNER JOIN bsc_bairros AS b ON b.ID = e2j.CD_BAIRRO   
                                                                 WHERE p.deficiencia IN(3, 2) AND e2j.ID = ? AND e2j.REGIONAL_ID = ? AND p.bsc_bairros_id = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 IS NULL AND p.status = 1 AND e2j.MUNICIPIO_ID = 94 OR
                                                                 p.deficiencia IN(3, 2) AND e2j.ID = ? AND e2j.REGIONAL_ID = ? AND p.bsc_bairros_id = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 = ' ' AND p.status = 1 AND e2j.MUNICIPIO_ID = 94      
                                                                 ORDER BY p.data_cadastro ASC");
                                        $result8->bindValue(1, $pessoa_local);
                                        $result8->bindValue(2, $pessoa_regional);
                                        $result8->bindValue(3, $pessoa_bairro);
                                        ...
                                        $result8 = $db->prepare("SELECT b.REGIONAL_NOME, e2j.NM_LOCAL_VOTACAO, p.secao_numero, p.bsc_bairros_id, b.NM_BAIRRO AS bairro, p.zona, p.local_votacao, p.id, p.nome    
                                                                 ...
                                                                 INNER JOIN 2024_locais_votacao AS e2j ON e2j.ID = s.LOCAL_VOTACAO_ID 
                                                                 INNER JOIN bsc_bairros AS b ON b.ID = e2j.CD_BAIRRO   
                                                                 WHERE p.deficiencia IN(3, 2) AND e2j.ID = ? AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 IS NULL AND p.status = 1 AND e2j.MUNICIPIO_ID = 94 OR
                                                                 p.deficiencia IN(3, 2) AND e2j.ID = ? AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 = ' ' AND p.status = 1 AND e2j.MUNICIPIO_ID = 94      
                                                                 ORDER BY p.data_cadastro ASC");
                                        $result8->bindValue(1, $pessoa_local);
                                        $result8->bindValue(2, $pessoa_regional);
                                        $result8->bindValue(3, $pessoa_local);
                                        ...
                                        $result8 = $db->prepare("SELECT b.REGIONAL_NOME, e2j.NM_LOCAL_VOTACAO, p.secao_numero, p.bsc_bairros_id, b.NM_BAIRRO AS bairro, p.zona, p.local_votacao, p.id, p.nome    
                                                                 ...
                                                                 INNER JOIN 2024_locais_votacao AS e2j ON e2j.ID = s.LOCAL_VOTACAO_ID 
                                                                 INNER JOIN bsc_bairros AS b ON b.ID = e2j.CD_BAIRRO   
                                                                 WHERE p.deficiencia IN(3, 2) AND p.bsc_bairros_id = ? AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 IS NULL AND p.status = 1 AND e2j.MUNICIPIO_ID = 94 OR
                                                                 p.deficiencia IN(3, 2) AND p.bsc_bairros_id = ? AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 = ' ' AND p.status = 1 AND e2j.MUNICIPIO_ID = 94      
                                                                 ORDER BY p.data_cadastro ASC");
                                        $result8->bindValue(1, $pessoa_bairro);
                                        $result8->bindValue(2, $pessoa_regional);
                                        $result8->bindValue(3, $pessoa_bairro);
                                        ...
                                        $result8 = $db->prepare("SELECT b.REGIONAL_NOME, e2j.NM_LOCAL_VOTACAO, p.secao_numero, p.bsc_bairros_id, b.NM_BAIRRO AS bairro, p.zona, p.local_votacao, p.id, p.nome    
                                                                 ...
                                                                 INNER JOIN 2024_locais_votacao AS e2j ON e2j.ID = s.LOCAL_VOTACAO_ID 
                                                                 INNER JOIN bsc_bairros AS b ON b.ID = e2j.CD_BAIRRO   
                                                                 WHERE p.deficiencia IN(3, 2) AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 IS NULL AND p.status = 1 AND e2j.MUNICIPIO_ID = 94 OR
                                                                 p.deficiencia IN(3, 2) AND e2j.REGIONAL_ID = ? AND p.tipo = 2 AND p.funcao_id = 4 AND p.secao_numero_2 = ' ' AND p.status = 1 AND e2j.MUNICIPIO_ID = 94      
                                                                 ORDER BY p.data_cadastro ASC");
                                        $result8->bindValue(1, $pessoa_regional);
                                        $result8->bindValue(2, $pessoa_regional);
                                        $result8->execute();
                                    ...
                                    while ($pessoa = $result8->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        $indicadores = vf_indicacao($pessoa['id']);
                                        ?>
                                        <option zona="<?= $pessoa['zona']; ?>" secao="<?= $pessoa['secao_numero']; ?>" local="<?= $pessoa['local_votacao']; ?>" value='<?= $pessoa['id']; ?>'><?= $qtdd; ?> - <?= $pessoa['REGIONAL_NOME'] != "" ? "REGIONAL " . $pessoa['REGIONAL_NOME'] : ""; ?> - <?= is_numeric($pessoa['bsc_bairros_id']) ? "BAIRRO " . $pessoa['bairro'] : ""; ?> - <?= $pessoa['NM_LOCAL_VOTACAO'] != "" ? "LDV " . $pessoa['NM_LOCAL_VOTACAO'] : ""; ?> - <?= $pessoa['nome']; ?> - ZONA <?= $pessoa['zona']; ?> - SEÇÃO <?= $pessoa['secao_numero']; ?></option>
                                        <?php
                                        $qtdd++;
                                    }
                                    ?>
