...
$sqlTotal = $db->prepare("SELECT p.id   
                ...
                WHERE p.secao_numero_2 IS NOT NULL AND p.bairro_2 IS NOT NULL AND p.regional_2 IS NOT NULL $condicao 
                GROUP BY p.id");
...
<div class="row">
    <div class="container col-xl-9 col-lg-9 col-md-10">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header" id="top">
                        <div class="row col-sm-12 col-xl-12 col-lg-12">
                            <h2 class="alt-h5-border-blue">Lista de Fiscais</h2>
                        </div>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Fiscais</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="container col-xs-2">
                                <div class="d-inline-block">
                                    ...
                                    <h2 class="mb-0"><?= qtd_voluntarios_distribuidos(2024, $pessoa_regional, $pessoa_funcao, $pessoa_zona, $pessoa_secao, $pessoa_local, $pessoa_indicacao); ?></h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="container col-xs-2">
                                <div class="d-inline-block">
                                    ...
                                    <h2 class="mb-0"><?= qtd_funcao_distribuidos(2024, 4, $pessoa_regional, $pessoa_funcao, $pessoa_zona, $pessoa_secao, $pessoa_situacao, $pessoa_local, $pessoa_indicacao); ?></h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="container col-xs-2">
                                <div class="d-inline-block">
                                    ...
                                    <h2 class="mb-0"><?= qtd_funcao_distribuidos(2024, 5, $pessoa_regional, $pessoa_funcao, $pessoa_zona, $pessoa_secao, $pessoa_situacao, $pessoa_local, $pessoa_indicacao); ?></h2>
                                </div>
                                <div class="float-right icon-circle-small  icon-box-sm  bg-success-light mt-1">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card px-3 bg-primary">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="float-xl-right float-none mt-xl-0 mt-4">
                                <a style="<?= ver_nivel(1) ? "" : "display: none;"; ?>" href="<?= PORTAL_URL; ?>view/fiscal/distribuicao" id="gerar" class="btn btn-success btn-sm"><i class="fas fa-sitemap mr-1"></i>Distribuição de Fiscais</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div id="ajax_pesquisa">
                <?php
                $result8 = $db->prepare("SELECT p.endereco, p.nm_mae, p.bsc_bairros_id, p.numero, p.nascimento, p.id, p.nome, p.cpf, p.funcao_id, p.celular, p.zona, p.secao_numero, p.local_votacao, p.cidade, p.tipo, p.usuario_id,      
                                        ...
                                        <div class="user-avatar-address mt-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="collapseSeven_<?= $pessoas['id']; ?>" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion4">
                                                    ...
                                                    <!--<div id="cancelamento" class="card-body scroll-distribuidos border mt-2">
                                                        <?php
                                                        /*$result33 = $db->prepare("SELECT u.id, u.nome, r.data_cadastro, r.motivo     
                                                                                    FROM 2024_voluntarios_removidos AS r 
                                                                                    INNER JOIN  seg_usuarios AS u ON u.id = r.responsavel_id 
                                                                                    WHERE r.voluntario_id = ?");
                                                        $result33->bindValue(1, $pessoas["id"]);
                                                        $result33->execute();
                                                        while ($responsavel = $result33->fetch(PDO::FETCH_ASSOC)) {
                                                            ?>
                                                            <div class="row">
                                                                <p>
                                                                <div class="col-md-12 detalhes-log">
                                                                    Adicionado por: <b><?= $responsavel['nome']; ?></b> em <b><?= obterDataBRTimestamp($responsavel['data_cadastro']); ?></b> às <b><?= obterHoraTimestamp($responsavel['data_cadastro']); ?></b>
                                                                    - Descrição: <b><?= $responsavel['motivo']; ?></b>
                                                                </div>
                                                                </p>
                                                            </div>
                                                            <?php
...
<script type="text/javascript" src="<?= PORTAL_URL; ?>scripts/fiscal/distribuidos.js"></script>