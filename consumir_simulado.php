...
$pleito = "8758";
$estado_sigla = "ac";
$cd_municipio = "01120"; // 01392 = Rio Branco - 01120 = Acrelandia
$qtd_bu = 0;
$ambiente = "simulado";
...
$json_url_2 = $url . '/' . $ambiente . '/' . $eleicao . '/arquivo-urna/' . $pleito . '/dados/' . $estado_sigla . '/' . $cd_municipio . '/' . formatarNumero($zona) . '/' . formatarNumero($secao) . '/p00' . $pleito . '-' . $estado_sigla . '-m' . $cd_municipio . '-z' . formatarNumero($zona) . '-s' . formatarNumero($secao) . '-aux.json';
...
if ($headers && strpos($headers[0], '200') !== false) {
    ...
    echo "----------------------------------------------<br/>";
    echo "Data de geração: " . $data_2['dg'] . "<br/>";
    echo "Hora de geração: " . $data_2['hg'] . "<br/>";
    echo "Formato: " . $data_2['f'] . "<br/>";
    echo "Status: " . $data_2['st'] . "<br/>";
    //echo "Descrição: " . $data_2['ds'] . "<br/>";
    echo "----------------------------------------------<br/>";

    foreach ($data_2['hashes'] as $hash) {

        echo "Hash: " . $hash['hash'] . "<br/>";
        echo "  Data do registro: " . $hash['dr'] . "<br/>";
        echo "  Hora do registro: " . $hash['hr'] . "<br/>";
        echo "  Status: " . $hash['st'] . "<br/>";
        //echo "  Descrição: " . $hash['ds'] . "<br/>";
        echo "  Arquivos:<br/>";
        ...
        foreach ($hash['arq'] as $arquivo) {
            if (strpos($arquivo['nm'], '-bu.dat') !== false && !file_exists("C:/xampp8/htdocs/siseleitoral/sn1/downloads/".$arquivo['nm'])) {
                ...
                echo "----------------------------------------------<br/>";
                echo "    Código da zona: " . $zona . " Carregado com sucesso!<br/>";
                echo "      Número da seção: " . $secao . " Carregado com sucesso!<br/>";
                //echo "----------------------------------------------<br/>";

                $link = $url . "/" . $ambiente . "/" . $eleicao . "/arquivo-urna/" . $pleito . "/dados/" . $estado_sigla . "/" . $cd_municipio . "/" . formatarNumero($zona) . "/" . formatarNumero($secao) . "/" . $hash['hash'] . "/" . $arquivo['nm'];
                //exec_python($arquivo, $link);

                echo "Link do BU: " . $link . "<br/>";
            }
        }
    }
} else {
