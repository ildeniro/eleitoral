		...
		$this->defaults = [
			...
			'fontdata' => [
				"poppins" => [
					...
					'EB' => "Poppins-ExtraBold.ttf",
					'EBI' => "Poppins-ExtraBoldItalic.ttf",
					'EL' => "Poppins-ExtraLight.ttf",
					'ELI' => "Poppins-ExtraLightItalic.ttf",
					'I' => "Poppins-Italic.ttf",
					'L' => "Poppins-Light.ttf",
					'LI' => "Poppins-LightItalic.ttf",
					'M' => "Poppins-Medium.ttf",
					'MI' => "Poppins-MediumItalic.ttf",
					'R' => "Poppins-Regular.ttf",
					'SM' => "Poppins-SemiBold.ttf",
					'SBI' => "Poppins-SemiBoldItalic.ttf",
					'T' => "Poppins-Thin.ttf",
					'TI' => "Poppins-ThinItalic.ttf",
					'useOTL' => 0xFF,
					'useKashida' => 75,
				],
				"dejavusanscondensed" => [
