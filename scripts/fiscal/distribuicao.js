...
function atualizar_fiscal() {
    ...
    postToURL(PORTAL_URL + 'view/fiscal/distribuicao?tipo_voluntario_guard=' + tipo_voluntario_guard + '&tipo_eleicao_guard=' + tipo_eleicao_guard + '&regional=' + regional + '&bairro=' + bairro + '&local=' + local + "&secao=" + secao);
}
//------------------------------------------------------------------------------
function atualizar_supervisor() {
    ...
    postToURL(PORTAL_URL + 'view/fiscal/distribuicao?tipo_voluntario_guard=' + tipo_voluntario_guard + '&tipo_eleicao_guard=' + tipo_eleicao_guard + '&regional2=' + regional2 + '&bairro2=' + bairro2 + '&local2=' + local2);
}
//------------------------------------------------------------------------------
// Usando jQuery
$('.dropdown').hover(
