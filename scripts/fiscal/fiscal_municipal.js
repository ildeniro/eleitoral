...
//----------------------------------------------------------------------------- 
    $('form#fiscal').submit(function () {
        ...
        if (formulario_validator("")) {
            ...
            $.post(PORTAL_URL + "dao/fiscal/add_municipio", {zona: zona, pessoas: pessoas, secao: secao, municipio: municipio, local: local, bairro: bairro}, function (data) {
                if (isNaN(data)) {
                    swal({
                    ...
                    postToURL(PORTAL_URL + 'view/fiscal/fiscal_municipal/?municipio=' + municipio + '&bairro=' + bairro + '&local=' + local);
                }
            }
            , "html");
            return false;
...
//------------------------------------------------------------------------------------------------------
function carregar_dados(bairro, zona, secao, municipio, local) {
